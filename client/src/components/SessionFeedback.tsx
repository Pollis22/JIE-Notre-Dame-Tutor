      ...
      {show && (
        ...
        >
          ...
          <div
            ...
            style={{ background: `linear-gradient(90deg, ${ND_BLUE} 0%, #0C2340 100%)` }}
          >
          ...
          <div className="p-4">
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  <CheckCircle className="h-8 w-8" style={{ color: ND_BLUE }} />
                  <p className="font-bold text-sm" style={{ color: ND_BLUE }}>
                    Thank you! 🦡
                  </p>
                  <p className="text-xs text-gray-500">
                    Your feedback helps us improve the University of Notre Dame AI Tutor experience.
                  </p>
                </motion.div>
              ) : (
                <motion.div key="form" className="space-y-3">
                      ...
                      {[1, 2, 3, 4, 5].map((star) => (
                        ...
                        >
                          <Star
                            ...
                            style={{
                              fill:   star <= activeRating ? ND_BLUE : "transparent",
                              color:  star <= activeRating ? ND_BLUE : "#d1d5db",
                              filter: star <= activeRating ? "drop-shadow(0 0 3px rgba(12, 35, 64,0.4))" : "none",
                            }}
                          />
                        </button>
                      ))}
                  ...
                  <textarea
                    ...
                    onFocus={(e) => (e.target.style.borderColor = ND_BLUE)}
                    onBlur={(e) => (e.target.style.borderColor = "rgba(12, 35, 64,0.2)")}
                  />
                  {comment.length > 0 && (
                  ...
                  {error && (
                    <p className="text-xs font-medium" style={{ color: ND_BLUE }}>
                      {error}
                    </p>
                  )}
