        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Everything you need to know about University of Notre Dame AI Tutor
            </p>
          </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="faq-2" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed" data-testid="faq-content-2">
                University of Notre Dame AI Tutor's voice engine lets you talk naturally—simply ask a question aloud, and the tutor responds instantly. No typing, no delays—just a smooth back-and-forth conversation like having a live teacher beside you.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="faq-4" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed" data-testid="faq-content-4">
                Nearly every subject and level is supported right now—from kindergarten to graduate school. Whether it's math, English, science, Spanish, or specialized study help, University of Notre Dame AI Tutor adapts to each learner's needs.
              </AccordionContent>
            </AccordionItem>
