    ...
    <div className="relative flex gap-5 md:gap-6">
      <div className="flex flex-col items-center flex-shrink-0">
        <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg"
          style={{ background: "#0C2340", boxShadow: "0 4px 14px rgba(12, 35, 64,0.3)" }}>
          {number}
        </div>
        {number < 5 && <div className="w-px flex-1 mt-2" style={{ background: "linear-gradient(to bottom, #0C2340, transparent)" }} />}
      </div>
      <div className="pb-10">
        <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-3" style={{ background: "rgba(12, 35, 64,0.06)" }}>
          {icon}
        </div>
        <h3 style={{ fontFamily: "'Red Hat Display', sans-serif", fontWeight: 700, fontSize: 20, color: "#0C2340", marginBottom: 6 }}>{title}</h3>
        <p style={{ fontSize: 15, lineHeight: 1.65, color: "#C99700", maxWidth: 480 }}>{desc}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen" style={{ background: "#FFFFFF", fontFamily: "'Red Hat Text', 'Source Sans 3', sans-serif" }}>
      ...
      <section className="relative overflow-hidden" style={{ paddingTop: 100, paddingBottom: 60 }}>
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, #FFF 0%, #FFFBEF 40%, #FFF5F5 70%, #FFF 100%)" }} />
        <div className="absolute top-20 right-0 w-96 h-96 rounded-full opacity-[0.04]" style={{ background: "#0C2340", filter: "blur(120px)" }} />

        <div className="relative max-w-6xl mx-auto px-4 md:px-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6"
              style={{ background: "rgba(12, 35, 64,0.06)", border: "1px solid rgba(12, 35, 64,0.12)" }}>
              <Calendar className="w-4 h-4" style={{ color: "#0C2340" }} />
              <span style={{ fontSize: 13, fontWeight: 600, color: "#0C2340" }}>Student Relationship Management</span>
            </div>

            <h1 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: "clamp(36px, 5vw, 56px)", fontWeight: 800, lineHeight: 1.08, color: "#0C2340", marginBottom: 20, letterSpacing: -1.5 }}>
              Your Academic<br />
              <span style={{ color: "#0C2340" }}>Command Center</span>
            </h1>

            <p style={{ fontSize: 19, lineHeight: 1.65, color: "#C99700", marginBottom: 32, maxWidth: 540 }}>
      ...
      <section className="py-16 md:py-20 px-4 md:px-12" style={{ background: "#FAFAFA" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p style={{ fontSize: 17, color: "#C99700", maxWidth: 640, margin: "0 auto", lineHeight: 1.6 }}>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            <div className="rounded-2xl p-7" style={{ background: "#FFFFFF", border: "1px solid #E8E8E8" }}>
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: "#FEE2E2" }}>
                  <AlertTriangle className="w-5 h-5" style={{ color: "#0C2340" }} />
                </div>
                <p style={{ fontWeight: 700, fontSize: 16, color: "#0C2340" }}>Without a system</p>
              </div>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5">
                    <div className="w-1.5 h-1.5 rounded-full mt-2 flex-shrink-0" style={{ background: "#0C2340" }} />
                    <span style={{ fontSize: 14, color: "#C99700", lineHeight: 1.5 }}>{t}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* With SRM */}
            <div className="rounded-2xl p-7" style={{ background: "#FFFFFF", border: "2px solid #0C2340", boxShadow: "0 4px 20px rgba(12, 35, 64,0.08)" }}>
              <div className="flex items-center gap-3 mb-5">
                ...
                <p style={{ fontWeight: 700, fontSize: 16, color: "#0C2340" }}>With your SRM</p>
              </div>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5">
                    ...
                    <span style={{ fontSize: 14, color: "#0C2340", fontWeight: 500, lineHeight: 1.5 }}>{t}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-4" style={{ background: "rgba(12, 35, 64,0.08)", border: "1px solid rgba(12, 35, 64,0.15)" }}>
              <span style={{ fontSize: 12, fontWeight: 600, color: "#0C2340", textTransform: "uppercase", letterSpacing: 1 }}>How It Works</span>
            </div>
            <h2 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: "clamp(24px, 4vw, 40px)", fontWeight: 800, color: "#0C2340", lineHeight: 1.15 }}>
              From Syllabus to Study Plan in <span style={{ color: "#0C2340" }}>60 Seconds</span>
            </h2>
          </div>

          <div className="ml-2 md:ml-8">
            <SRMStep number={1} icon={<Upload className="w-5 h-5" style={{ color: "#0C2340" }} />}
            ...
            <SRMStep number={2} icon={<Calendar className="w-5 h-5" style={{ color: "#0C2340" }} />}
            ...
            <SRMStep number={3} icon={<CheckSquare className="w-5 h-5" style={{ color: "#0C2340" }} />}
            ...
            <SRMStep number={4} icon={<Mic className="w-5 h-5" style={{ color: "#0C2340" }} />}
            ...
            <SRMStep number={5} icon={<BarChart3 className="w-5 h-5" style={{ color: "#0C2340" }} />}
      ...
      <section className="py-16 md:py-20 px-4 md:px-12" style={{ background: "#FAFAFA" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: "clamp(24px, 4vw, 40px)", fontWeight: 800, color: "#0C2340", lineHeight: 1.15, marginBottom: 8 }}>
              Everything You Need to <span style={{ color: "#0C2340" }}>Stay Ahead</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg" style={{ background: "#FFFFFF", border: "1px solid #E8E8E8" }}>
                <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-4" style={{ background: "rgba(12, 35, 64,0.06)", color: "#0C2340" }}>{f.icon}</div>
                <h3 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: 17, fontWeight: 700, marginBottom: 6, color: "#0C2340" }}>{f.title}</h3>
                <p style={{ fontSize: 14, lineHeight: 1.6, color: "#C99700" }}>{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 px-4 md:px-12" style={{ background: "#FFFFFF" }}>
        <div className="max-w-5xl mx-auto">
          <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid #E8E8E8", boxShadow: "0 8px 40px rgba(0,0,0,0.06)" }}>
            <div className="p-2" style={{ background: "#0C2340" }}>
            ...
            <div className="p-7 md:p-10" style={{ background: "linear-gradient(135deg, #FFF7ED 0%, #FFF 100%)" }}>
              <h3 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: "clamp(22px, 3vw, 30px)", fontWeight: 800, color: "#0C2340", marginBottom: 12 }}>
                Your Tutor Doesn't Just Know Your Subject.<br />
                <span style={{ color: "#0C2340" }}>It Knows Your Semester.</span>
              </h3>
              <p style={{ fontSize: 16, color: "#C99700", lineHeight: 1.65, marginBottom: 28, maxWidth: 600 }}>
                Other AI tools answer questions. Your Notre Dame AI Tutor opens the conversation with what matters most — because it sees your entire academic picture.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-xl p-5" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(0,0,0,0.06)" }}>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span style={{ fontSize: 13, fontWeight: 600, color: "#C99700" }}>Other AI</span>
                  </div>
                  <div className="rounded-lg p-4" style={{ background: "#F5F5F5" }}>
                    <p style={{ fontSize: 14, color: "#C99700", fontStyle: "italic" }}>"How can I help you today?"</p>
                  </div>
                  <p className="mt-3" style={{ fontSize: 12, color: "#999" }}>No context. No awareness. No plan.</p>
                </div>

                <div className="rounded-xl p-5" style={{ background: "rgba(12, 35, 64,0.03)", border: "2px solid rgba(12, 35, 64,0.15)" }}>
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-2 h-2 rounded-full animate-pulse" style={{ background: "#28A745" }} />
                    <span style={{ fontSize: 13, fontWeight: 600, color: "#0C2340" }}>University of Notre Dame AI Tutor + SRM</span>
                  </div>
                  <div className="rounded-lg p-4" style={{ background: "rgba(12, 35, 64,0.04)" }}>
                    <p style={{ fontSize: 14, color: "#0C2340", fontWeight: 500, fontStyle: "italic" }}>"Welcome back! I see you have an Organic Chemistry midterm in 3 days covering reaction mechanisms and stereochemistry. You've completed 2 of 4 study tasks for it. Want to start with the mechanism review?"</p>
                  </div>
                  <p className="mt-3" style={{ fontSize: 12, color: "#0C2340", fontWeight: 600 }}>Full academic awareness. Proactive guidance. Personal advisor.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-7 md:p-10" style={{ background: "#FFFFFF", border: "1px solid #E8E8E8" }}>
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-4" style={{ background: "rgba(12, 35, 64,0.08)" }}>
                  <Shield className="w-3.5 h-3.5" style={{ color: "#0C2340" }} />
                  <span style={{ fontSize: 12, fontWeight: 600, color: "#0C2340", textTransform: "uppercase", letterSpacing: 1 }}>For Student-Athletes</span>
                </div>
                <h3 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: "clamp(22px, 3vw, 28px)", fontWeight: 800, color: "#0C2340", marginBottom: 12 }}>
                  Protect Your Eligibility.<br />Automatically.
                </h3>
                <p style={{ fontSize: 15, color: "#C99700", lineHeight: 1.65, marginBottom: 20 }}>
              ...
              <div className="w-full md:w-72 flex-shrink-0 rounded-xl p-5" style={{ background: "#FFFBEF", border: "1px solid rgba(12, 35, 64,0.1)" }}>
                <p style={{ fontSize: 13, fontWeight: 700, color: "#0C2340", marginBottom: 12, textTransform: "uppercase", letterSpacing: 0.5 }}>Alert Types</p>
                <div className="space-y-3">
                  {[
                    { label: "No Activity", desc: "7+ days without a session", color: "#EA580C" },
                    { label: "Declining Score", desc: "Engagement below 40/100", color: "#0C2340" },
                    { label: "Missed Deadlines", desc: "3+ overdue tasks", color: "#0C2340" },
                    ...
                    <div key={i} className="flex items-start gap-2.5">
                      ...
                      <div>
                        <p style={{ fontSize: 13, fontWeight: 600, color: "#0C2340" }}>{a.label}</p>
                        <p style={{ fontSize: 12, color: "#C99700" }}>{a.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <section className="py-16 md:py-20 px-4 md:px-12" style={{ background: "#FFFFFF" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 800, color: "#0C2340", marginBottom: 8 }}>
            Your Engagement Score, <span style={{ color: "#0C2340" }}>Explained</span>
          </h2>
          <p style={{ fontSize: 16, color: "#C99700", maxWidth: 500, margin: "0 auto 32px", lineHeight: 1.6 }}>
            A weekly 0–100 score that tells you exactly where you stand — so you never have to wonder.
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { label: "Sessions", weight: "40%", desc: "Tutoring sessions completed vs target (3/week per course)", color: "#0C2340" },
              ...
              <div key={i} className="rounded-xl p-5" style={{ background: "#FAFAFA", border: "1px solid #E8E8E8" }}>
                ...
                <p style={{ fontSize: 14, fontWeight: 700, color: "#0C2340", marginBottom: 4 }}>{s.label}</p>
                <p style={{ fontSize: 12, color: "#C99700", lineHeight: 1.4 }}>{s.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              { range: "0–29", label: "Critical", color: "#0C2340", bg: "rgba(220,38,38,0.08)" },
            ].map((r, i) => (
              <div key={i} className="flex items-center gap-2 px-4 py-2 rounded-lg" style={{ background: r.bg }}>
                ...
                <span style={{ fontSize: 13, color: "#0C2340" }}>{r.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-16 md:py-20 px-4 md:px-12" style={{ background: "#0C2340" }}>
        <div className="max-w-3xl mx-auto text-center">
          <h2 style={{ fontFamily: "'Red Hat Display', sans-serif", fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 800, color: "#FFFFFF", marginBottom: 12 }}>
            Stop Reacting. Start <span style={{ color: "#E8B84A" }}>Leading</span> Your Semester.
          </h2>
      ...
      <footer className="py-8 md:py-10 px-4 md:px-12 max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4" style={{ borderTop: "1px solid #E8E8E8", background: "#FFFFFF" }}>
        <div className="flex items-center gap-3">
          ...
          <span style={{ fontSize: 12, color: "#C99700" }}>University of Notre Dame · AI Tutor Program</span>
        </div>
        <span style={{ fontSize: 11, color: "#DAD7CB" }}>University of Notre Dame · AI Tutor Program</span>
      </footer>
    </div>
  );
}
