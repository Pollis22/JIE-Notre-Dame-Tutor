...
router.get('/:id/export', async (req, res) => {
  try {
    ...
    if (format === 'pdf') {
      ...
      doc.fontSize(24).font('Helvetica-Bold').text('University of Notre Dame AI Tutor', { align: 'center' });
      ...
      doc.fontSize(7).fillColor('#999999').text(
        `Generated by University of Notre Dame AI Tutor | ${new Date().toLocaleDateString()} at ${new Date().toLocaleTimeString()}`,
        { align: 'center' }
      );
